...
function HeroSection({name}) {
    return (
        <section className="font-semibold text-center h-[90vh] pt-8 pb-16 flex flex-col justify-between">
            <div className="">
                <motion.p
                    initial={{
                        opacity: 0,
            ...
            <div className="flex flex-col items-center gap-2 text-lg">
                <Link to='/projects' className="bg-lime-bg text-lime-fg px-6 rounded-full">Projects</Link>
                <Link to='/contact' className="bg-white text-lime-fg px-6 border border-lime-fg rounded-full">Connect</Link>
